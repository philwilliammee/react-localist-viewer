...
var _EventsContext = _interopRequireDefault(
  require("../../../../context/EventsContext")
);
...
const AgendaListView = (props) => {
  ...
  const { events } = (0, _react.useContext)(_EventsContext.default);
    ...
    /*#__PURE__*/ _react.default.createElement(
      ...
      /*#__PURE__*/ _react.default.createElement(
        ...
        /*#__PURE__*/ _react.default.createElement(
          ...
          /*#__PURE__*/ _react.default.createElement("h3", null, event.title)
        ),
        /*#__PURE__*/ _react.default.createElement(
          "div",
          {
        ...
        /*#__PURE__*/ _react.default.createElement(
          ...
          /*#__PURE__*/ _react.default.createElement(
            "p",
            null,
            /*#__PURE__*/ _react.default.createElement(_partials.EventImg, {
...
AgendaListView.propTypes = {
  ...
  hideaddcal: _propTypes.default.oneOfType([
    _propTypes.default.string,
    _propTypes.default.number,
  ]).isRequired,
  truncatedescription: _propTypes.default.string.isRequired,
  hidedescription: _propTypes.default.oneOfType([
    _propTypes.default.string,
    _propTypes.default.number,
  ]).isRequired,
  hideimages: _propTypes.default.oneOfType([
    _propTypes.default.string,
    _propTypes.default.number,
  ]).isRequired,
